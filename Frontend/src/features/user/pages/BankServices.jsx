...
const BankServices = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`https://queue-project-1.onrender.com/api/branch-services/${branchId}`)
            ...
            {bookingResult ? (
              <div className="success-card">
                ...
                <div className="success-details">
                  ...
                  <div className="sd-row"><span>Counter</span><strong>{bookingResult.branchServiceCounter || "—"}</strong></div>
